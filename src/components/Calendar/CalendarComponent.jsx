                ...
                <tbody>
                    {rows.map((row, rowIndex) => (
                        <React.Fragment key={rowIndex}>
                            <tr>
                                <td rowSpan={4} className="text-start bg-[#F5F5F5] p-2 rounded-b-lg">
                                    <div className="flex">
                            ...
                            <tr className="align-top border-b border-[#2E263D1F]">
                                <td rowSpan={3} className="text-start bg-[#F5F5F5] p-2 rounded-b-lg">
                                ...
                                <td rowSpan={3} className="text-start bg-[#F5F5F5] p-2 rounded-b-lg">
                                    <div>
                                        {row.departments.map((dept, index) => (
                                            <p
                                                key={index}
                                                className={`py-1 px-3 w-full rounded-lg mb-2 ${
                                                    dept === "SHOP"
                                ...
                                <td rowSpan={3} className="text-start bg-[#F5F5F5] p-2 rounded-b-lg">
                                    <div>
                                        <p className="text-white bg-[#56CA00] py-1 px-2 w-full rounded-lg">
                                            {row.scheduleType}
                                        </p>
                                    </div>
                                </td>
                                <td rowSpan={3} className="text-start bg-[#F5F5F5] p-2 rounded-b-lg text-nowrap">
                                    <div>
                                ...
                                <td colSpan={5} className="text-center text-[#2E263DE5] text-sm bg-[#F5F5F5] p-2 border-r-2 border-[#2E263D1F]">
                                    {row.hours[0]}hrs
                                </td>
                                <td colSpan={5} className="text-center text-[#2E263DE5] text-sm bg-[#F5F5F5] p-2 border-r-2 border-[#2E263D1F]">
                                    {row.hours[1]}hrs
                            ...
                            <tr className='border-b-2 border-[#2E263D1F]'>
                                <td className="text-center text-[#2E263DE5] text-sm bg-[#F5F5F5] p-2 border-r-2 border-[#2E263D1F]">
                                    {row.hours[0]}hrs
                                </td>
                                <td className="text-center text-[#2E263DE5] text-sm bg-[#F5F5F5] p-2 border-r-2 border-[#2E263D1F]">
                                    {row.hours[0]}hrs
