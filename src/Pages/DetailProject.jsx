      ...
      <div className="bg-white shadow-md rounded-lg">
        ...
        <div className="bg-[#00000026]">
          <div className="flex items-center gap-4 sm:p-4 p-2">
            <div>
              <FaArrowLeft
                className="bg-white sm:p-2 p-1 sm:text-4xl text-2xl rounded-lg cursor-pointer"
                onClick={() => navigate("/completedproject")}
              />
            </div>
            <div className="flex gap-3 items-center w-full">
              <div>
                <img
                  className="sm:size-12 size-8 sm:max-w-12 max-w-8 rounded-full"
                  src={dummyuser}
                  alt="img"
                />
              </div>
              <div className="sm:flex items-center justify-between gap-2 w-full">
                <div>
                  <p className="font-medium sm:text-3xl text-lg">
                    Cristine Easom
                  </p>
                  <p className="sm:text-sm text-xs text-[#2E263DB2]">
                    ceasomw@theguardian.com
                  </p>
                </div>
                <p className="md:text-2xl sm:text-lg text-xs font-medium">
